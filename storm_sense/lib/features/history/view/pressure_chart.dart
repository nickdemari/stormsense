...
class PressureChart extends StatelessWidget {
  ...
  /// Extracts the converted pressure from a [Reading].
  /// Defaults to [Reading.pressure] when null.
  ...
  Widget build(BuildContext context) {
    ...
    final mapper = valueMapper ?? (Reading r) => r.pressure;
    ...
    final minP = smoothed.reduce(math.min) - 2;
    final maxP = smoothed.reduce(math.max) + 2;
